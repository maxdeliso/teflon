 ...
 * notes: to compile, javac test\Teflon.java
 *        to run,     java -cp . test.Teflon
 *
 * (assuming source is in test\)
 */
        ...
        public void run() {
            ...
            while(parent.alive()) {
                ...
                if(inputDatagram.getOffset() > 0) {
                    /* if there was data received from remote, post it to local handler's message queue */
